  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <PageHeader
        eyebrow="Explore"
        title="Map view"
        subtitle="Placeholder map pins using dummy coordinates. Swap in Mapbox later without changing listing cards."
      />
      <div className="rounded-xl border border-gray-200 bg-stellar-50 h-80 flex items-center justify-center text-sm text-stellar-700 mb-6">
        Dummy map canvas — {properties.length} properties in the local catalog
      </div>

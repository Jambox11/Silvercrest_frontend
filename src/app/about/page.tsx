  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      <PageHeader
        ...
        subtitle="A demo marketplace for discovering, listing, and trading tokenized real estate on Stellar — powered by sample catalogs so every screen works without live chain risk."
      />
      <div className="grid sm:grid-cols-3 gap-4 mb-10">
        ...
        <StatCard label="Data mode" value="Sample" hint="Swap to API when ready" />
      </div>
      <div className="prose prose-sm max-w-none text-gray-600 space-y-4">
        <p>
          ...
          fractional lots in this build are simulated against rich sample inventory.
        </p>
        <p>

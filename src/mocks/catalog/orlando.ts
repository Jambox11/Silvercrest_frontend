...
/** Sample catalog entry for Orlando, FL. */
export const CATALOG_ORLANDO: Property = {
  ...
  yearBuilt: 2011,
  featured: false,
  description: 'Sample tokenized listing in Orlando, FL. Specs and pricing are simulated for the SilverKrest marketplace demo.',

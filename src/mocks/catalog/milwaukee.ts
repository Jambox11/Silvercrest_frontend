...
/** Dummy catalog entry for Milwaukee, WI. */
export const CATALOG_MILWAUKEE: Property = {
  ...
  yearBuilt: 2008,
  featured: false,
  description: 'Dummy tokenized listing in Milwaukee, WI. Specs and pricing are simulated for the SilverKrest marketplace demo.',

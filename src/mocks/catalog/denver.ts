...
/** Sample catalog entry for Denver, CO. */
export const CATALOG_DENVER: Property = {
  ...
  yearBuilt: 1995,
  featured: true,
  description: 'Sample tokenized listing in Denver, CO. Specs and pricing are simulated for the SilverKrest marketplace demo.',

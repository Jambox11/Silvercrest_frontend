...
/** Dummy catalog entry for Baltimore, MD. */
export const CATALOG_BALTIMORE: Property = {
  ...
  yearBuilt: 2019,
  featured: false,
  description: 'Dummy tokenized listing in Baltimore, MD. Specs and pricing are simulated for the SilverKrest marketplace demo.',

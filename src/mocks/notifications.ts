...
export const MOCK_NOTIFICATIONS: AppNotification[] = [
  ...
  },
  {
    ...
    body: 'Sample settlement recorded for $600,000.',
    read: true,
    href: '/activity',
  ...
  },
  {
    ...
    body: 'Sample identity documents are waiting in the review queue.',
    read: true,
    href: '/settings',
  ...
  },
  {
    ...
    body: 'Indexer catch-up may lag for a few minutes. Marketplace sample data remains available.',
    read: true,

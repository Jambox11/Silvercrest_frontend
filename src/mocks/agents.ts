...
export const MOCK_AGENTS: AgentProfile[] = [
  {
    ...
    location: 'Miami, FL',
    bio: 'Sample profile for the demo marketplace. Specializes in tokenized oceanfront assets and fractional beach inventory.',
  ...
  },
  {
    ...
    bio: 'Works penthouses, lofts, and mixed-use buildings on the sample Stellar registry.',
  ...
  },
  {
    ...
    location: 'Austin, TX',
    bio: 'Sample coverage for Texas and Arizona residential inventory.',
